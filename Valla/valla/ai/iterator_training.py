...
from valla.ai.vocabulary import training_vocabulary
...
cfg_fonts = cfg.Config('config.ini').section('FONTS_TRAINING')
cfg_training = cfg.Config('config.ini').section('TRAINING')
...
batch_load_per_epoch = int(cfg_training['batch_load_per_epoch'])

display_frequency_in_steps = int(cfg_training['display_frequency_in_steps'])
validation_frequency_in_steps = int(cfg_training['validation_frequency_in_steps'])
model_save_frequency_in_steps = int(cfg_training['model_save_frequency_in_steps'])

''' Init Data Iterator '''
max_word_length = max(map(len, training_vocabulary))
