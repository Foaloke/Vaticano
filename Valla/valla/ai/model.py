...
import valla.ai.dataiteratorinputoutput as di
    ...
    def init_placeholders(self):       
        ...
        if self.mode == 'train':
            ...
            decoder_start_token = tf.ones(
                shape=[self.batch_size, 1], dtype=tf.int32) * di.start_token
            decoder_end_token = tf.ones(
                shape=[self.batch_size, 1], dtype=tf.int32) * di.end_token            
    ...
    def build_decoder(self):
        ...
        with tf.variable_scope('decoder'):
            ...
            if self.mode == 'train':
                ...
                start_tokens = tf.ones([self.batch_size,], tf.int32) * di.start_token
                end_token = di.end_token
